...
const options = {
	...
	readQueue: 'lexdec_quiz_dbread',
	writeQueue: 'lexdec_quiz_dbwrite',
	taskQueue: 'lexdec_quiz_taskworker',
};
...
worker.init()
	.then(() => {
		...
		worker.useHandler(defaultHandler, connection, 'lexdec', transactionOps);
		worker.start();
	})
	.catch(err => {
